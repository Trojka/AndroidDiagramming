...
public class DoSelectConnectionsAndSetEligibleForEditingGestureAction extends GestureActionBase<DiagramDesignerView> {

	public DoSelectConnectionsAndSetEligibleForEditingGestureAction(DiagramDesignerView view) {
		super(view);
	}
