...
public class CheckOnSingleCommandCondition extends GestureConditionBase<DiagramDesignerView> {

	public CheckOnSingleCommandCondition(DiagramDesignerView view) {
		super(view);
	}
	...
	public boolean checkCondition(GestureEvent motion, TouchGesture gesture) {
		...
		return hitResult.size() == 1 && hitResult.get(0).isOnCommand();
	}
}
