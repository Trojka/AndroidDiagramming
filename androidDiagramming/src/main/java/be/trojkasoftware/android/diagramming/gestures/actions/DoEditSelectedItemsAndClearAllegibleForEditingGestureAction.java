...
public class DoEditSelectedItemsAndClearAllegibleForEditingGestureAction extends GestureActionBase<DiagramDesignerView> {

	public DoEditSelectedItemsAndClearAllegibleForEditingGestureAction(DiagramDesignerView view) {
		super(view);
	}
